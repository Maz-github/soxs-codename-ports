...
function create() {
	...
	//bg.moves = true;
	//bg.velocity.x = 10;
	coolBackdrop = new FlxBackdrop(Paths.image('ballsweat')); // second argument: FlxAxes is required to determinate in what axes the sprite should be repeated, default to XY
